...
const { upload_prefix } = require("cloudinary/lib/config")();

const isSecure = !(upload_prefix && upload_prefix.slice(0, 5) === 'http:');
const https = isSecure ? require('https') : require('http');

const Cache = require('cloudinary/lib/cache');
const utils = require("cloudinary/lib/utils");
const UploadStream = require('cloudinary/lib/upload_stream');
