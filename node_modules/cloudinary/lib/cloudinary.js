...
exports.uploader = require("cloudinary/lib/uploader");
exports.api = require("cloudinary/lib/api");
let account = require("cloudinary/lib/provisioning/account");

exports.provisioning = {
  account: account
};
exports.PreloadedFile = require("cloudinary/lib/preloaded_file");
exports.Cache = require('cloudinary/lib/cache');
...
const { generateImageResponsiveAttributes, generateMediaAttr } = require('cloudinary/lib/utils/srcsetUtils');
...
exports.v2 = require('cloudinary/lib/v2');
