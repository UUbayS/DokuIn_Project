...
exports.config = require("cloudinary/lib-es5/config");
exports.utils = require("cloudinary/lib-es5/utils");
exports.uploader = require("cloudinary/lib-es5/uploader");
exports.api = require("cloudinary/lib-es5/api");
var account = require("cloudinary/lib-es5/provisioning/account");

exports.provisioning = {
  account: account
};
exports.PreloadedFile = require("cloudinary/lib-es5/preloaded_file");
exports.Cache = require('cloudinary/lib-es5/cache');
...
var _require = require('cloudinary/lib-es5/utils/srcsetUtils'),
...
exports.v2 = require('cloudinary/lib-es5/v2');