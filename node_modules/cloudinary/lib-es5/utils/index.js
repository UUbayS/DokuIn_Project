...
var smart_escape = require("cloudinary/lib-es5/utils/encoding/smart_escape");
var consumeOption = require('cloudinary/lib-es5/utils/parsing/consumeOption');
var toArray = require('cloudinary/lib-es5/utils/parsing/toArray');

var _require = require('cloudinary/lib-es5/utils/encoding/base64EncodeURL'),
    base64EncodeURL = _require.base64EncodeURL;

var encodeDoubleArray = require('cloudinary/lib-es5/utils/encoding/encodeDoubleArray');

var config = require("cloudinary/lib-es5/config");
var generate_token = require("cloudinary/lib-es5/auth_token");
var crc32 = require('cloudinary/lib-es5/utils/crc32');
var ensurePresenceOf = require('cloudinary/lib-es5/utils/ensurePresenceOf');
var ensureOption = require('cloudinary/lib-es5/utils/ensureOption').defaults(config());
var entries = require('cloudinary/lib-es5/utils/entries');
var isRemoteUrl = require('cloudinary/lib-es5/utils/isRemoteUrl');
var getSDKVersions = require('cloudinary/lib-es5/utils/encoding/sdkAnalytics/getSDKVersions');
...
try {
  ...
  utils.VERSION = require('cloudinary/package.json').version;
} catch (error) {
  utils.VERSION = '';
}
...
var _require2 = require('cloudinary/lib-es5/utils/consts'),
